package com.tcloud.auth.translator;
...
public class TCloudWebResponseExceptionTranslator implements WebResponseExceptionTranslator
{
    ...
    public ResponseEntity<?> translate(Exception e)
    {
        ...
        {
            message = "不支持该认证类型";
            return status.body(CommonResult.failed(message));
        }
        if (e instanceof InvalidTokenException && StringUtils.containsIgnoreCase(e.getMessage(), "Invalid refresh token (expired)"))
        {
