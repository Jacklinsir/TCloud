...
/**
 * Description: 授权码保存到Redis，以确保认证服务器集群的一致性
 * <br/>
 * RedisAuthenticationCodeService
...
public class RedisAuthenticationCodeService extends RandomValueAuthorizationCodeServices
{
    ...
    protected void store(String code, OAuth2Authentication authentication)
    {
        ...
        try
        {
            conn.hSet(AUTH_CODE_KEY.getBytes(StandardCharsets.UTF_8), code.getBytes(StandardCharsets.UTF_8), SerializationUtils.serialize(authentication));
