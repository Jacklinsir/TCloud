...
import com.tcloud.common.core.domain.TCloudAuthUser;
import com.tcloud.common.core.domain.constant.PageConstant;
import com.tcloud.common.core.domain.constant.RegexpConstant;
...
public enum HttpUtil
{
    ...
    public static String getCurrentUsername() {
        ...
        if (principal instanceof TCloudAuthUser) {
            return ((TCloudAuthUser) principal).getUsername();
        }
